...
````
GET /causal/api/v1/usr/zhy19/results HTTP/1.1
Host: localhost:9000
Authorization: Basic emh5MTk6MTIzNDU2
````
...
````
GET /causal/api/v1/usr/zhy19/results/fgs_data_small.txt_1466172140585.txt HTTP/1.1
Host: localhost:9000
Authorization: Basic emh5MTk6MTIzNDU2
````
...
````
{
  ...
  "path": "/usr/zhy19/results/fgs_data_small.txt_146172140585.txt"
}
````
...
## Example 9: Compare algorithm result files
...
````
GET /causal/api/v1/usr/zhy19/results/compare/fgs_sim_data_20vars_100cases.csv_1466171729046.txt!!fgs_data_small.txt_1467305104859.txt HTTP/1.1
Host: localhost:9000
Authorization: Basic emh5MTk6MTIzNDU2
````
